...
class PurpleNode {
    ...
    factory PurpleNode.fromJson(Map  json) => PurpleNode(
        ...
        owner: SponsorClass.fromJson(json["owner"]),
        ...
        edgeMediaToSponsorUser: EdgeMediaToSponsorUser.fromJson(json["edge_media_to_sponsor_user"]),
        ...
        edgeMediaToComment: EdgeMediaToComment.fromJson(json["edge_media_to_comment"]),
...
class StickyNode {
    ...
    factory StickyNode.fromJson(Map json) => StickyNode(
        sponsor: SponsorClass.fromJson(json["sponsor"]),
    );
...
class EdgeSidecarToChildrenEdge {
    ...
    factory EdgeSidecarToChildrenEdge.fromJson(Map  json) => EdgeSidecarToChildrenEdge(
        node: IndecentNode.fromJson(json["node"]),
    );
